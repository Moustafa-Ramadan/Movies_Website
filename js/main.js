...
function displayMovies(term){
    ...
    for (let i = 0; i <term.length ; i++) {
        list+= `<div class="col-md-4  movie-poster  overflow-hidden">
        <div class="movie-details position-relative rounded ">
        <img src='https://image.tmdb.org/t/p/w500/${term[i].poster_path}' class="w-100 " alt="">
        <div class="layout position-absolute rounded d-flex align-items-center">
            <div>
...
$(".item").click(function (e) {
    ...
    {
        let coctactWidth=$("#contact").offset().top;
        $("html,body").animate({scrollTop:coctactWidth},coctactWidth);
    }
...
$(".input-contact").on("change",function (){
    if(validName  && validEmail  && validphone  && validAge  && validpassword  )
    {
